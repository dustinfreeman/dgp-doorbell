...
namespace DGPDoorbell
{
    ...
    static class Email
    {
        ...
        /// <param name="ImagePath">location of image to attach to email</param>
        static public int SendEmail(string ToAddress, string Subject, string Body, string ImagePath)
        {
            int r = 0;
            string[] addresses;
            ...
            foreach (string s in addresses)
            {
                ...
                r = DoEmail(s.Trim(), Subject, Body, ImagePath);
            }
        ...
        /// <param name="Body">text of body of email</param>
        /// <param name="ImagePath">location of image to attach to email</param>
        static private int DoEmail(string ToAddress, string Subject, string Body, string ImagePath)
        {         
            ...
            try
            {
                //create attachment from picture of provided path
